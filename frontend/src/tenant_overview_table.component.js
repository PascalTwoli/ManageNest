...
import { fetchTenants, deleteTenant, updateTenant  } from "./services/tenantService";
  ...
  const handleDelete = async (tenantId) => {
	...
	if (confirmed) {
		...
		if (result) {
			...
			setTenants((prevTenants) => prevTenants.filter((tenants) => tenants.tenantId !== tenantId));
              ...
              <tr key={index}>
                ...
                <td>
                  ...
                  >
                    <Dropdown.Toggle
                      ...
                      size="sm"
                      style={{
                        color: row.paymentStatus === "Paid" ? "green" : "Due" ? "brown" : "Null" ? "grey" : "blue",
                        cursor: "pointer",
                        fontSize: "14px",
                      }}
                    >
                    ...
                    <Dropdown.Menu>
						<Dropdown.Item eventKey="Due">---</Dropdown.Item>
                     	<Dropdown.Item eventKey="Paid">Paid</Dropdown.Item>
                      	<Dropdown.Item eventKey="Due">Due</Dropdown.Item>
                    </Dropdown.Menu>
                  </Dropdown>
                  {/* <DropdownButton
						as="a"
                ...
                <td>
                  <div className="actionbutton d-flex">
                    <span className="" onClick={() => handleDelete(tenants)}>
                      Delete
                    </span>
                  ...
                  {activeItem && <TenantProfilesOffcanvas
                    show={showOffcanvas}
